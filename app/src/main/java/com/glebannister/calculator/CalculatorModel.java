package com.glebannister.calculator;
        ...
        if (actionId == R.id.equals && state == State.secondArgInput && inputStr.length() > 0) {
            ...
            switch (actionSelected) {
                ...
                case R.id.division:
                    ...
                    break;
                case R.id.square:
                    inputStr.append(firstArg * firstArg);
                case  R.id.root:
                    inputStr.append(Math.sqrt(firstArg));
                case R.id.sin:
                    inputStr.append(Math.sin(firstArg));
                case R.id.cos:
                    inputStr.append(Math.cos(firstArg));
                case R.id.tan:
                    inputStr.append(Math.tan(firstArg));
            }
